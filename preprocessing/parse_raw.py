...
def main(args):
    ...
    out_path = in_path.replace('/00Train/', '/RAW/')
    ...
    files_out = glob(os.path.join(out_path, '*.npy'))
...
if __name__ == "__main__":
    ...
    parser.add_argument('-p', '--path', type=str, default='/mnt/data1/RoD/00Train')
