...
def raw_func(raw_image, index, out_path, isp_func):
    ...
    cv2.imwrite(f"{save_path}",  raw_image)
    # return
...
def main():
    ...
    # dataset path
    in_path = "/home/gongzheli/data/hdr_video/raw_data/LUCID_TRI054S-C_222503282__20240913172020827_video0.raw"
    out_path = "//mnt/data1/hdr_video/raw/video0_frames"
