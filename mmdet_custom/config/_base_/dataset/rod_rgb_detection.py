...
data_root = '/home/user1/data/RoD/'
# data_root = '/home/wzh/data/RoD/'
...
train_pipeline = [  # 训练数据处理流程
    dict(type='LoadImageFromFile', color_type='unchanged'),  # 第 1 个流程，从文件路径里加载图像。
    dict(
...
train_dataloader = dict(  # 训练 dataloader 配置
    ...
    dataset=dict(  # 训练数据集的配置
        ...
        metainfo=metainfo,
        data_root=data_root,
        data_prefix=dict(img='RGBltm'),  # 图片路径前缀
...
val_evaluator = dict(
    type='CocoMetric',
    ann_file=data_root + 'annotations/rgb/val.json',
    metric=['bbox'],
    format_only=False,
